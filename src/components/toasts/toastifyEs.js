...
class Toastify {
    ...
    _init(options) {
        ...
        this.options.style.background =
            this.options.background || options.backgroundColor;
    ...
    _buildToast() {
        ...
        if (this.options.needActionBtn) {
            ...
            divBtnAction.style.cssText =
                "display: flex; align-items: center; margin: 0px 5px";
            const btnAction = document.createElement("button");
            btnAction.style.cssText =
                "background-color: #000; outline: 0; border: none; border-radius: 20px; color: #fff; font-weight: bold;";
